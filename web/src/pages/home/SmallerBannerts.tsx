...
function SmallerBannerts() {
  return (
    <div className="container mx-auto grid grid-cols-1 gap-4 px-4 py-8 lg:grid-cols-2 lg:gap-0 lg:px-0 lg:py-0">
      {/* Left Banners */}
      <div className="left-banners flex flex-col gap-4 lg:gap-0">
        ...
        {/* Squares */}
        <div className="squares grid grid-cols-1 gap-4 sm:grid-cols-2 lg:gap-0">
          {/* AirPods Max */}
